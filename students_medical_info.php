...
<body>
   ...
   <h2 color="Black" >Students Medical Information</h2>
    <table   cellpadding="1" cellspacing="1">
       <tr> <thead><td>RollNo</td><td>Blood Group</td><td>Medical Conditions</td></thead></tr>
        
        <tr>
<?php
$sql= "SELECT * FROM `students_medical_info`";
