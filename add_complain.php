...
<form action="add_complain.php" method="POST">
  ...
  <label for="fname"><h1>Complain:</h1></label><br>      
  <input type="text" id="fname" name="complain" placeholder="Write your complain here"><br>
...
$sql = "INSERT INTO `complaints` (`rollNo`, `complaint`) VALUES ('$rname', '$complain')";
